...
const userSchema = new mongoose.Schema(
  {
    ...
    occupation: { type: String, enum: ["student", "businessman", "others"], default: null },
    occupationDetail: { type: String, trim: true, default: null },
    gender: { type: String, enum: ["male", "female", "others"], default: null },
    isPremium: { type: Boolean, default: false },
    isSuperPremium: { type: Boolean, default: false },
